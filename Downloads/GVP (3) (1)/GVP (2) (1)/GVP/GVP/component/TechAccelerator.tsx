                ...
                <div className="lg:col-span-4 space-y-4">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">🎯 Custom Domain / Interest</label>
                                <input 
                                    type="text" 
                                    value={customDomain}
                                    onChange={(e) => setCustomDomain(e.target.value)}
                                    placeholder="e.g. Web3, AI/ML, DevOps, Cloud Architecture..."
                                    className="w-full p-3 bg-white text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none transition-all text-sm shadow-sm"
                                />
                                <p className="text-xs text-slate-400 mt-1">Enter your interested domain to customize the acceleration plan</p>
                            </div>
                            ...
                            {/* Skills Text Area */}
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">💬 Skills / Notes (Optional)</label>
                                <textarea 
                                    value={resumeText}
                                    ...
                                    placeholder="Add additional skills or notes. You can use this WITH or WITHOUT a resume file."
                                />
                                <p className="text-xs text-slate-400 mt-1">✓ Use resume file, ✓ Use skills text, or ✓ Use both together</p>
                            </div>
